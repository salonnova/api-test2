...
<div class="container small">
   ...
   <fieldset >
         ...
         <div class="form-group">
            ...
            <input type="text" class="red"  name="word" id="book_name"></input><br>

            <label  for="book_name" class="red-title">{{ __('日本語での意味') }}<span class="badge badge-danger ml-2">{{ __(' (必須!)') }}</span></label>
            <input type="text" class="red" name="mean" id="book_name"></input>
            ...
            <div class="">
            <a href="{{ route('word.index') }}" class="totop" role="button">
               <i  aria-hidden="true"></i>{{ __('トップページへ') }}
            </a>
   ...
   <div class="form-group">
            <a href="{{ route('word.list') }}" class="btn btn-outline-secondary" >
